...
int countAbove70(double arr[], int size) {
    int count = 0;
...
void MP_Question_2 (double A[][15], String S[]) {
	...
	int count = countAbove70(ArrayOfSum, n);

	printf("\nTHERE ARE %d COUNTRIES ABOVE 70 LIFE EXPECTANCY AFTER DEDUCTION\n", count);
...
main()
{
    ...
    */
	...
	MP_Question_2 (LifeExpectancy_Factors, Territories);
